            ...
            <Flex direction="column">
                {
                    ...
                    (
                        <Box>
                            <Input value={address} onChange={(e) => setAddress(e.target.value)} placeholder="ERC20 Coin address" m={6} width="300px"/>
                            <Input value={amount} onChange={(e) => setAmount(e.target.value)} placeholder="Amount" m={6} width="100px"/>
                        </Box>
                    ) : (
                        <Box>
